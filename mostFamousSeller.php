...
?>
    ...
    <body class="body" onload="loadDChart();">
        <div class="col-12">
        ...
        <div class="col-12 d-flex justify-content-center align-items-center" style="margin-top: 20px;">
            <div class="row table-responsive">
                <div class="col-12" style="width: 650px;">
                    <h2 class="text-center text-dark fw-bold">Most Famous Seller (Pie Chart)</h2>
        ...
        <script>
            function loadDChart() {
                ...
                request.open("POST", "loadFamsellerProcess.php", true);
                request.send();
            }
        </script>
